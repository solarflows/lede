...
int rtl8366_smi_reset_vlan(struct rtl8366_smi *smi);
int rtl8366_smi_enable_vlan(struct rtl8366_smi *smi, int enable);
int rtl8366_smi_enable_all_ports(struct rtl8366_smi *smi, int enable);
