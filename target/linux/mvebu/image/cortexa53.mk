define Device/catdrive_catdrive
  ...
  DEVICE_PACKAGES += kmod-crypto-arc4 kmod-crypto-cbc \
  kmod-crypto-ccm kmod-crypto-cmac kmod-crypto-ctr kmod-crypto-cts \
  kmod-crypto-ecb kmod-crypto-ecdh kmod-crypto-echainiv \
  kmod-crypto-fcrypt kmod-crypto-gcm kmod-crypto-ghash kmod-crypto-hmac \
  kmod-crypto-md4 kmod-crypto-md5 \
  kmod-crypto-pcbc kmod-crypto-rng kmod-crypto-seqiv kmod-crypto-sha256 \
